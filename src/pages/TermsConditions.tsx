      ...
      <div className="wrapper page">
        ...
        <div className="block">
          ...
          <p>
            ...
            and DigitalKwarts OÜ ("Company," “we," “us," or “our”), concerning
            your access to and use of the https://socialize.berlin/ website as
            ...
            (collectively, the “Site”). We are registered in Estonia and have
            our registered office at Sepapaja 6, Tallinn, Tallinn 15551. Our VAT
            number is EE101955643. You agree that by accessing the Site, you
        ...
        <div className="block">
          ...
          <p>
            ...
            Policy: https://socialize.berlin/data-protection. By using the Site,
            ...
            Germany. If you access the Site from any other region of the world
            ...
            data to Germany, and you agree to have your data transferred to and
        ...
        <div className="block">
          ...
          <p>
            ...
            of Germany, and the use of the United Nations Convention of
            ...
            provisions of the law of your country of residence. DigitalKwarts OÜ
            and yourself both agree to submit to the non-exclusive jurisdiction
            of the courts of Berlin, which means that you may make a claim to
            defend your consumer protection rights in regards to these
            Conditions of Use in Germany, or in the EU country in which you
            reside.
          </p>
        </div>
        <div className="block">
          ...
          <p>
            ...
            arbitration shall be Berlin, Germany. The language of the
        ...
        <div className="block">
          ...
          <p>
            ...
            Estonia <br />
            <br />
            <a href="mailto:info@kwrts.com">info@kwrts.com</a>
          </p>
        </div>
      </div>
      <Footer />
